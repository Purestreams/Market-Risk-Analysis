...
LSTM_FINAL_EPOCHS = 8
LSTM_FINAL_SEQUENCE_LENGTH = 72
LSTM_FINAL_TAIL_ALPHA = 0.0125
LSTM_TAIL_CALIBRATION_LEVELS = (0.01, 0.0125, 0.015, 0.0175, 0.02)
VAE_WINDOW = 24
...
class ProjectPaths:
    ...
    report_markdown_path: Path = PROJECT_ROOT / "outputs" / "report.md"
    report_tex_path: Path = PROJECT_ROOT / "outputs" / "report.tex"
    report_todo_path: Path = PROJECT_ROOT / "outputs" / "report_todo.md"
